...
for i in range(num_envs):
    ...
    gym.attach_camera_to_body(h2, envs[i], body_handle, gymapi.Transform(camera_offset, camera_rotation), i % 2)
    print("matrix:", gym.get_camera_view_matrix(sim, envs[i], h2))
