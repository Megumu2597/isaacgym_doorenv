...
# asset_descriptors = [
#     AssetDesc("mjcf/1555111990_pull_blue_floatinghook.xml", False),
#     AssetDesc("mjcf/open_ai_assets/fetch/push.xml", False),
...
# ]
asset_descriptors = [
AssetDesc("mjcf/1555111990_pull_blue_right_v2_gripper_motor.xml", True),
]
